...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="max-w-4xl mx-auto mt-16 bg-white rounded-xl shadow-lg p-6 md:p-8 relative z-10">
        <!-- Progress Container -->
        <div class="max-w-3xl mx-auto mb-10 flex flex-col md:flex-row items-center gap-6">
            <!-- Progress Info -->
            <div class="flex flex-col items-center">
                <span class="text-2xl md:text-3xl font-bold text-red-800" x-text="Math.round((currentStep / totalSteps) * 100) + '%'">0%</span>
                <span class="text-xs uppercase text-gray-500 tracking-wide">Completado</span>
            </div>
            <!-- Progress Bar -->
            <div class="w-full">
                <div class="h-2 bg-gray-200 rounded-full overflow-hidden">
                    <div class="h-full bg-red-800 rounded-full transition-all duration-500" x-bind:style="'width: ' + (currentStep / totalSteps * 100) + '%'"></div>
                </div>
            </div>
        </div>
        ...
        <div class="relative max-w-3xl mx-auto mb-12">
            ...
            <div class="absolute top-4 left-10 h-0.5 bg-red-800 transition-all duration-600" x-bind:style="'width: ' + (currentStep / totalSteps * 100) + '%'"></div>
            <div class="flex justify-between">
                <template x-for="(step, index) in [
                    ...
                    <div class="flex flex-col items-center relative z-10 w-24">
                        <div class="w-10 h-10 rounded-full flex items-center justify-center bg-gray-100 border-2 border-gray-200 text-gray-500 font-semibold text-sm transition-all duration-300"
                             :class="{
        ...
        <!-- Form Sections -->
        <div class="max-w-3xl mx-auto bg-white rounded-xl shadow-md p-8 border border-gray-100">
            <form x-data="{ 
                currentStep: 1,
                totalSteps: 7,
                formData: {}
            }" @submit.prevent="submitForm" class="bg-white">
                
                <!-- Datos Generales -->
                <div x-show="currentStep === 1" class="bg-white">
                    <h4 class="text-lg font-semibold text-gray-800 mb-6 pb-3 border-b border-gray-200 flex items-center">
                        <i class="fas fa-building text-red-800 mr-2"></i> Datos Generales
                    </h4>
                    @include('components.formularios.seccion-datos-generales')
                </div>

                <!-- Domicilio -->
                <div x-show="currentStep === 2" class="bg-white">
                    <h4 class="text-lg font-semibold text-gray-800 mb-6 pb-3 border-b border-gray-200 flex items-center">
                ...
                <!-- Constitución -->
                <div x-show="currentStep === 3" class="bg-white">
                    <h4 class="text-lg font-semibold text-gray-800 mb-6 pb-3 border-b border-gray-200 flex items-center">
                ...
                <!-- Accionistas -->
                <div x-show="currentStep === 4" class="bg-white">
                    <h4 class="text-lg font-semibold text-gray-800 mb-6 pb-3 border-b border-gray-200 flex items-center">
                        <i class="fas fa-users text-red-800 mr-2"></i> Accionistas
                    </h4>
                    @include('components.formularios.seccion-accionistas')
                </div>

                <!-- Documentos -->
                <div x-show="currentStep === 5" class="bg-white">
                    <h4 class="text-lg font-semibold text-gray-800 mb-6 pb-3 border-b border-gray-200 flex items-center">
                        <i class="fas fa-file-alt text-red-800 mr-2"></i> Documentos
                    </h4>
                    @include('components.formularios.seccion-documentos')
                </div>

                <!-- Confirmación -->
                <div x-show="currentStep === 6" class="bg-white">
                    <h4 class="text-lg font-semibold text-gray-800 mb-6 pb-3 border-b border-gray-200 flex items-center">
                ...
                <!-- Finalización -->
                <div x-show="currentStep === 7" class="bg-white">
                    <h4 class="text-lg font-semibold text-gray-800 mb-6 pb-3 border-b border-gray-200 flex items-center">
                ...
                <div class="flex justify-between gap-4 mt-6">
                    <button type="button" 
                            ...
                            @click="currentStep--"
                            class="w-full md:w-auto px-6 py-3 bg-gray-600 text-white rounded-md hover:bg-gray-700 transition-all duration-300 transform hover:-translate-y-0.5">
                        Anterior
                    </button>
                    <button type="button" 
                            x-show="currentStep < totalSteps"
                            @click="currentStep++"
                            class="w-full md:w-auto px-6 py-3 bg-red-800 text-white rounded-md hover:bg-red-900 transition-all duration-300 transform hover:-translate-y-0.5">
                        Siguiente
                    </button>
                    <button type="submit" 
                            x-show="currentStep === totalSteps"
