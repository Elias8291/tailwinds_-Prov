...
<form method="POST" action="{{ route('password.email') }}" class="space-y-6">
    ...
    <div class="space-y-3">
        ...
        <a href="{{ url('/') }}" class="group w-full bg-white text-primary font-medium py-2.5 px-4 rounded-lg transition-all duration-300 shadow-sm hover:shadow-md transform hover:-translate-y-0.5 border border-primary/30 hover:border-primary/50 relative overflow-hidden inline-flex items-center justify-center text-sm">
