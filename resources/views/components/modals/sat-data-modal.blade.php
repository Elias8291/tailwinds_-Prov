    ...
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-3xl max-h-[90vh] overflow-hidden">
        ...
        <div class="px-6 py-4 bg-gradient-to-br from-[#9d2449] to-[#7a1d37] border-b border-[#9d2449]/10">
            <div class="flex items-center justify-between">
                ...
                <button type="button" onclick="window.closeSatModal()" class="text-white/80 hover:text-white transition-colors duration-200">
        ...
        <div class="bg-gray-50 px-6 py-4 border-t border-gray-100">
            <div class="flex justify-end">
                <button type="button" onclick="window.closeSatModal()" 
...
<script>
// Modal SAT: autocontenible para abrir/cerrar
window.openSatModal = function() {
