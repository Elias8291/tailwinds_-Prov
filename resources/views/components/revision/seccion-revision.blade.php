...
<div class="mt-4 border rounded-lg shadow-sm bg-white" 
    ...
    <div class="p-4 flex items-center justify-between border-b cursor-pointer"
        ...
        <h3 class="text-lg font-medium text-gray-900">
            Revisión de Sección
            <span x-show="estado === 'aprobado'" class="ml-2 px-2 py-1 text-sm rounded-full bg-green-100 text-green-800">Aprobado</span>
            <span x-show="estado === 'rechazado'" class="ml-2 px-2 py-1 text-sm rounded-full bg-red-100 text-red-800">Rechazado</span>
        </h3>
    ...
    <div x-show="isCommentsOpen" 
        ...
        <div class="mt-2">
            <template x-if="error">
                <div class="text-sm text-red-600 bg-red-50 p-2 rounded" x-text="error"></div>
            </template>
            <template x-if="success">
                <div class="text-sm text-green-600 bg-green-50 p-2 rounded" x-text="success"></div>
            </template>
        </div>
        ...
        <div class="flex space-x-3">
            <button
                ...
                class="inline-flex items-center justify-center rounded-md border border-transparent bg-[#9d2449] py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-[#8a203f] focus:outline-none focus:ring-2 focus:ring-[#9d2449] focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed">
            ...
            <button
                ...
                class="inline-flex items-center justify-center rounded-md border border-transparent bg-red-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed">
