    ...
    <div class="max-w-[95%] xl:max-w-[90%] 2xl:max-w-[85%] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg border border-gray-200/50 mb-6">
            <div class="p-6">
                ...
                <form method="GET" action="{{ route('proveedores.index') }}" class="space-y-5">
                        ...
                        <div class="group md:col-span-2">
                            ...
                            <div class="relative">
                                <input type="text" name="search" id="search" value="{{ request('search') }}" 
                                       placeholder="RFC, nombre o razón social..."
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                <select name="estado" id="estado" class="w-full appearance-none bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-700 hover:border-green-300 focus:border-green-500 focus:ring-2 focus:ring-green-500/20 transition-all duration-200">
                                    ...
                                    <option value="Pendiente Renovacion" {{ request('estado') == 'Pendiente Renovacion' ? 'selected' : '' }}>Pendiente Renovación</option>
                                </select>
                    ...
                    <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                        <div class="text-sm text-gray-600">
                            @if(request()->has('search') || request()->has('estado'))
                                Filtros aplicados - 
                            @endif
                            <span class="font-medium text-gray-900">{{ $proveedores->total() }}</span> proveedores encontrados
                        </div>
            ...
            <div class="hidden md:block">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <x-pagination :items="$proveedores" label="proveedores" />
                </div>
            </div>
        </div>
    </div>
