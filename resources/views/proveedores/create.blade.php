        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-6 mb-8 transform hover:scale-[1.01] transition-all duration-300 border border-gray-100">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">Ingresa los datos del nuevo proveedor</p>
                </div>
            </div>
        </div>
            ...
            <form method="POST" action="{{ route('proveedores.store') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="pv" id="pv" 
                           ...
                           required maxlength="10" value="{{ old('pv') }}">
                    @error('pv')
                ...
                <div>
                    ...
                    <input type="date" name="fecha_registro" id="fecha_registro" 
                           class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-[#B4325E] focus:ring focus:ring-[#B4325E] focus:ring-opacity-20 transition-colors duration-200"
                           required value="{{ old('fecha_registro', date('Y-m-d')) }}">
                ...
                <div>
                    ...
                    <input type="date" name="fecha_vencimiento" id="fecha_vencimiento" 
                           class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-[#B4325E] focus:ring focus:ring-[#B4325E] focus:ring-opacity-20 transition-colors duration-200"
                           required value="{{ old('fecha_vencimiento') }}">
                ...
                <div>
                    ...
                    <textarea name="observaciones" id="observaciones" rows="4"
                              class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-[#B4325E] focus:ring focus:ring-[#B4325E] focus:ring-opacity-20 transition-colors duration-200">{{ old('observaciones') }}</textarea>
                    @error('observaciones')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
