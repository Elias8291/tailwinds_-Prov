        ...
        <form method="GET" action="{{ route('documentos.index') }}" class="space-y-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
                ...
                <div class="xl:col-span-2 group">
                    ...
                    <div class="relative">
                        <input type="text" name="search" id="search" 
                               ...
                               class="w-full bg-white border border-gray-200 rounded-lg pl-9 pr-3 py-2.5 text-sm text-gray-700 placeholder-gray-400 hover:border-pink-300 focus:border-pink-500 focus:ring-2 focus:ring-pink-500/20 transition-all duration-200">
                ...
                <div class="group">
                    ...
                    <div class="relative">
                        <select name="tipo_persona" id="tipo_persona" class="w-full appearance-none bg-white border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-700 hover:border-blue-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all duration-200">
                ...
                <div class="group">
                    ...
                    <div class="relative">
                        <select name="perPage" id="perPage" class="w-full appearance-none bg-white border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-700 hover:border-purple-300 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all duration-200">
                ...
                <div class="group">
                    ...
                    <button type="submit" 
                            class="w-full inline-flex items-center justify-center px-4 py-2.5 bg-gradient-to-r from-[#9d2449] to-[#8a203f] hover:from-[#8a203f] hover:to-[#7a1d37] text-white text-sm font-medium rounded-lg focus:outline-none focus:ring-2 focus:ring-[#9d2449]/30 transition-all duration-200 shadow-sm hover:shadow-md transform hover:scale-[1.02]">
                ...
                <div class="group">
                    ...
                    <a href="{{ route('documentos.index') }}" 
                       class="w-full inline-flex items-center justify-center px-4 py-2.5 bg-gradient-to-r from-gray-100 to-gray-200 hover:from-gray-200 hover:to-gray-300 border border-gray-300 text-gray-700 text-sm font-medium rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400/20 transition-all duration-200 shadow-sm hover:shadow-md transform hover:scale-[1.02]">
            ...
            @if(request()->hasAny(['search', 'tipo_persona']))
            <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                <div class="flex items-center space-x-2">
                    <span class="text-xs font-medium text-gray-600">Filtros activos:</span>
                    
                    @if(request('search'))
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-pink-100 text-pink-800 border border-pink-200">
                ...
                <div class="text-xs text-gray-500">
                    {{ $documentos->total() }} resultado{{ $documentos->total() != 1 ? 's' : '' }} encontrado{{ $documentos->total() != 1 ? 's' : '' }}
                </div>
            </div>
            @endif
        </form>
