...
@section('content')
<div class="min-h-screen py-6 bg-gradient-to-br from-gray-50 to-gray-100">
            ...
            <form method="GET" action="{{ route('logs.index') }}" class="space-y-4">
                ...
                <div class="flex flex-wrap items-end gap-4">
                    ...
                    <div class="flex-1 min-w-[200px]">
                        <label for="level" class="block text-xs font-medium text-gray-600 mb-1">
                            <i class="fas fa-layer-group mr-1 text-[#9d2449]"></i>
                            Nivel
                        </label>
                        <select name="level" id="level" class="w-full text-sm rounded-lg border-gray-200 focus:border-[#9d2449] focus:ring focus:ring-[#9d2449]/20">
                    ...
                    <!-- Filtro por canal -->
                    <div class="flex-1 min-w-[200px]">
                        <label for="channel" class="block text-xs font-medium text-gray-600 mb-1">
                            <i class="fas fa-broadcast-tower mr-1 text-[#9d2449]"></i>
                            Canal
                        </label>
                        <select name="channel" id="channel" class="w-full text-sm rounded-lg border-gray-200 focus:border-[#9d2449] focus:ring focus:ring-[#9d2449]/20">
                            <option value="">Todos</option>
                    ...
                    <div class="flex-1 min-w-[200px]">
                        <label for="date_from" class="block text-xs font-medium text-gray-600 mb-1">
                            <i class="fas fa-calendar-alt mr-1 text-[#9d2449]"></i>
                            Desde
                        </label>
                        <input type="date" name="date_from" id="date_from" value="{{ request('date_from') }}" 
                               class="w-full text-sm rounded-lg border-gray-200 focus:border-[#9d2449] focus:ring focus:ring-[#9d2449]/20">
                    </div>
