...
<body>
    ...
    <div class="contenido">
        ...
        @else
            Se hace referencia a su solicitud de renovación de registro ante el Padrón de Proveedores de la Administración Pública Estatal fechada el {{ $fecha_solicitud ?? '15 de enero de 2025' }}, recibida en esta Dirección de Recursos Materiales el {{ $fecha_recepcion ?? '20 de enero de 2025' }}.
            <br><br>
            Al respecto, se informa que una vez revisada y analizada su solicitud, así como verificado el cumplimiento de los requisitos establecidos, se procedió a la <strong>RENOVACIÓN</strong> de su registro ante el Padrón de Proveedores de la Administración Pública Estatal.
            <br><br>
            Su registro anterior con cédula {{ $cedula_anterior ?? 'PV-2024-001' }} con vigencia hasta el {{ $fecha_vencimiento ?? '19 DE ENERO DE 2025' }}, ha sido renovado exitosamente, asignándosele la nueva cédula de inscripción {{ $cedula_nueva ?? 'PV-2025-002' }}, cuya vigencia será anual a partir del {{ $fecha_inicio ?? '20 DE ENERO DE 2025' }} hasta el {{ $fecha_vigencia ?? '19 DE ENERO DE 2026' }}.
            <br><br>
            Se le recuerda que para futuras renovaciones, deberá presentar su solicitud dentro de los siete días hábiles previos a su vencimiento. En caso de que omita presentar dicha solicitud en el plazo indicado, se cancelará el registro a su vencimiento, sin perjuicio de lo anterior, podrá formular una nueva solicitud de inscripción.
            <br><br>
