            ...
            <div class="grid md:grid-cols-2 gap-4 sm:gap-8 items-center">
                ...
                <div class="flex justify-center order-1 md:order-none">
                    <div class="float-animation">
                        <img src="{{ asset('images/ImagenError.png') }}" alt="Error 404" class="w-48 sm:w-64 h-auto drop-shadow-xl">
                    </div>
                </div>
                ...
                <div class="text-center md:text-left order-2 md:order-none">
                    <div class="relative mb-6">
                        <div class="number-container">
                            <h1 class="text-8xl sm:text-9xl font-bold glow-effect tracking-wider">404</h1>
                        </div>
                    </div>
