<nav class="bg-white border-b border-gray-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pl-0"> <!-- Removed left padding -->
        <div class="flex justify-between h-16">
            <div class="flex items-center"> <!-- Ensure no extra margin -->
                <div class="flex md:hidden">
                    <button type="button" @click="sidebarOpen = !sidebarOpen" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary">
                ...
                <!-- Logo -->
                <div class="flex-shrink-0 flex items-center ml-0"> <!-- Ensure no left margin -->
