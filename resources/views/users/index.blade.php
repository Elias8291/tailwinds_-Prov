    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg border border-gray-200/50 mb-6">
            <div class="p-6">
                ...
                <form method="GET" action="{{ route('users.index') }}" class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <!-- Estado -->
                        <div class="group">
                            <label for="status" class="block text-xs font-medium text-gray-700 mb-2 flex items-center">
                            ...
                            <div class="relative">
                                <select name="status" id="status" class="w-full appearance-none bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-700 hover:border-green-300 focus:border-green-500 focus:ring-2 focus:ring-green-500/20 transition-all duration-200">
                    ...
                    <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                        <div class="text-sm text-gray-600">
                            @if(request()->has('search') || request()->has('status'))
                                Filtros aplicados - 
                            @endif
                            <span class="font-medium text-gray-900">{{ method_exists($users, 'total') ? $users->total() : $users->count() }}</span> usuarios encontrados
                        </div>
            ...
            <div class="hidden md:block">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <x-pagination :items="$users" label="usuarios" />
                </div>
            </div>
        </div>
    </div>
