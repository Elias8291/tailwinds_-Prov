                ...
                <div class="space-y-5">
                    ...
                    <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                        <div class="text-sm text-gray-600">
                            <span x-show="tieneElementosFiltrados()">Filtros aplicados - </span>
                            <span class="font-medium text-gray-900" x-text="notificacionesFiltradas.length"></span> notificaciones encontradas
                        </div>
