                            ...
                            <div class="bg-white border border-gray-100 rounded-lg p-4 shadow-sm hover:shadow-md transition-all duration-200">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <p class="text-sm font-medium text-gray-900">{{ $dia->fecha_inicio->format('d/m/Y') }}</p>
                                            <p class="text-xs text-gray-500">{{ $dia->descripcion }}</p>
                                        </div>
                                    </div>
                                    <button onclick="showDeleteConfirmation('{{ $dia->id }}', '{{ $dia->fecha_inicio->format('d/m/Y') }}')"
        ...
        <div class="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg border border-gray-200/50 mb-6">
            ...
            <div class="hidden md:block">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    @include('components.pagination', ['items' => $citas, 'label' => 'citas'])
                </div>
            </div>
        </div>
    </div>
